...
> **[AWESOME-BOOKS-APP]** AwesomeBook is a simple website that displays a list of books and allows users to add and remove books from that list. This project is made  using html, css and JS best practices.
...
```sh
  cd my-folder
  git clone git@github.com:baqar-abbas/Awesome-books-redefine.git
```
<p align="right">(<a href="#readme-top">back to top</a>)</p>
